...
public class Aims {
	...
	public static void main(String[] args) {
		...
		store.addMedia(new Book("Java Programming", "Technology", 29.99f));
		store.addMedia(new DigitalVideoDisc("The Lord of the Rings", "Fantasy", "Peter Jackson", 180, 19.99f));
		store.addMedia(
				new CompactDisc("Michael Jackson's Thriller", "Pop", 15.99f, 42, "John Landis", "Michael Jackson"));
